        ...
        {expanded && (
          <View style={styles.matchContainer}>
            ...
            <View style={styles.matchCard}>
              <Text style={styles.matchInfo}>20th T20,Seven Districts Ground, UAE</Text>
              <View style={styles.matchRow}>
                ...
                <View style={styles.timeContainer}>
                  ...
                  <Text style={styles.matchTime}>06:00 PM</Text>
                </View>
              </View>
            </View>
            ...
            {/* Match Card 2 */}
            <View style={styles.matchCard}>
              <Text style={styles.matchInfo}>26th T20,Seven Districts Ground, UAE</Text>
              <View style={styles.matchRow}>
                {/* Left Side - Teams */}
                <View style={styles.teamsColumn}>
                <View style={styles.team}>
                    <Image 
                      ...
                      style={styles.teamLogo} 
                    />
                    <Text style={styles.teamName}>Ajman </Text>
                  </View>
                  <View style={styles.team}>
                    <Image 
                      source={{ uri: 'https://cricclubs.com/documentsRep/profilePics/29ecff89-5017-405f-bd94-63491fb21c72.png' }} // replace with actual team logo URL
                ...
                <View style={styles.timeContainer}>
                  <Text style={styles.matchDay}>Tomorrow</Text>
                  <Text style={styles.matchTime}>09:30 PM</Text>
                </View>
              </View>
            </View>
