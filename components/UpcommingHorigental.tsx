...
// const navItems = ['Ind', 'Emirates', 'Wbbl', 'Fuj','Dub'];

// const UpcommingHorigental: React.FC<MatchHorizontalProps> = ({ setActiveTab }) => {
//   return (
//     <FlatList
//       data={navItems}
//       horizontal
...
// export default UpcommingHorigental;
import React from 'react';
...
const UpcommingHorigental: React.FC<MatchHorizontalProps> = ({ setActiveTab, activeTab }) => {
  return (
    <FlatList
      data={navItems}
      horizontal
